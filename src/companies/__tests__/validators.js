...
const expectedCompanyDetailsValidation = {
	name: {
		presence: {
			allowEmpty: false,
...
test('company validator is correct', () => {
  expect(companyDetailsValidation).toEqual(expectedCompanyDetailsValidation);
});

test('company base validator is correct', () => {
  expect(basesValidation).toEqual(expectedBasesValidation);
});