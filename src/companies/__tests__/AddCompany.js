...
test('has the correct title', () => {
  ...
  expect(title.textContent).toBe('Aggiungi Azienda');
});
...
test('is showing company details', () => {
  ...
  expect(container.firstChild.querySelector('input#company-name')).toBeInTheDocument();
  expect(container.firstChild.querySelector('input#company-fiscal-code')).toBeInTheDocument();
  expect(container.firstChild.querySelector('input#company-iva-code')).toBeInTheDocument();
  expect(container.firstChild.querySelector('input#company-inps')).toBeInTheDocument();
  expect(container.firstChild.querySelector('input#company-inail')).toBeInTheDocument();
});
...
test('default company details are correct', () => {
  ...
  expect(container.firstChild.querySelector('input#company-name').value).toBe('');
  expect(container.firstChild.querySelector('input#company-fiscal-code').value).toBe('');
  expect(container.firstChild.querySelector('input#company-iva-code').value).toBe('');
  expect(container.firstChild.querySelector('input#company-inps').value).toBe('');
  expect(container.firstChild.querySelector('input#company-inail').value).toBe('');
});
